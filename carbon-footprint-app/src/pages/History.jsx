...
/** ====== CONFIG ====== */
// Backend base URL and fetch options 
...
function History() {
  ...
  // Build category dropdown options from the server-provided summary
  ...
  // Open delete modal and confirm handler
